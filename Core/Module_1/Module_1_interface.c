...
void module_1_set ( int , void * ptr ) ;
void module_1_set ( int , void * ptr ) ; 
void module_1_request ( int , ARGS *  ) ;



component_manager_node_t module_1_node = 
{
    module_1_set , 
    module_1_set , 
    module_1_request ,
...
{
    component_manager_attach_node ( MODULE_1 , & module_1_node ) ;
}
